...
import com.molinaro.cursomc.domain.Pagamento;
import com.molinaro.cursomc.domain.PagamentoComBoleto;
import com.molinaro.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRepository.save(Arrays.asList(p1,p2,p3, p4, p5, p6, p7, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(
				null, 
				"Marco Aurelio Molinaro", 
				"marco.amolinaro@gmail.com", 
				"78954418503", 
		...
		Endereco e3 = new Endereco(null, "Rua Matoso", "104", "Sala 8", "Centro", "38777012", cli2, c2);
